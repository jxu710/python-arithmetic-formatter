def arithmetic_arranger(problems, shown_result=False):
  arranged_problems = ""
  ...
  for problem in problems:
    ...
    # use eval() parse expression and run python code
    result = eval(item[0] + item[1] + item[2])

    # show result line
    result_line.append(f"{result:>{width}}")
  ...
  # add result_line if 2nd argument is True
  if shown_result:
